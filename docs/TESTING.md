...
malformed/unsupported/ambiguous state, an accepted UID 70 data-root owner, a
rejected UID 12345 owner, symlink failures, and partial non-empty state. It also
supplies a fake `podman unshare` command to
